...
namespace MonoDevelop.SourceEditor.OptionPanels
{
	internal partial class GeneralOptionsPanel
	{
		...
		private global::Gtk.CheckButton foldImportsCheckbutton;
		...
		protected virtual void Build ()
		{
			...
			w13.Fill = false;
			// Container child vbox5.Gtk.Box+BoxChild
			this.foldImportsCheckbutton = new global::Gtk.CheckButton ();
			this.foldImportsCheckbutton.CanFocus = true;
			this.foldImportsCheckbutton.Name = "foldImportsCheckbutton";
			this.foldImportsCheckbutton.Label = global::Mono.Unix.Catalog.GetString ("Fold _imports by default");
			this.foldImportsCheckbutton.DrawIndicator = true;
			this.foldImportsCheckbutton.UseUnderline = true;
			this.vbox5.Add (this.foldImportsCheckbutton);
			global::Gtk.Box.BoxChild w14 = ((global::Gtk.Box.BoxChild)(this.vbox5 [this.foldImportsCheckbutton]));
			w14.Position = 4;
			w14.Expand = false;
			w14.Fill = false;
			this.alignment3.Add (this.vbox5);
			this.vbox1.Add (this.alignment3);
			global::Gtk.Box.BoxChild w16 = ((global::Gtk.Box.BoxChild)(this.vbox1 [this.alignment3]));
			w16.Position = 3;
			w16.Expand = false;
			w16.Fill = false;
			// Container child vbox1.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w17 = ((global::Gtk.Box.BoxChild)(this.vbox1 [this.GtkLabel15]));
			w17.Position = 4;
			w17.Expand = false;
			w17.Fill = false;
			// Container child vbox1.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w18 = ((global::Gtk.Box.BoxChild)(this.vbox6 [this.wordWrapCheckbutton]));
			w18.Position = 0;
			w18.Expand = false;
			w18.Fill = false;
			// Container child vbox6.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w19 = ((global::Gtk.Box.BoxChild)(this.vbox6 [this.antiAliasingCheckbutton]));
			w19.Position = 1;
			w19.Expand = false;
			w19.Fill = false;
			this.alignment4.Add (this.vbox6);
			this.vbox1.Add (this.alignment4);
			global::Gtk.Box.BoxChild w21 = ((global::Gtk.Box.BoxChild)(this.vbox1 [this.alignment4]));
			w21.Position = 5;
			w21.Expand = false;
			w21.Fill = false;
			this.Add (this.vbox1);
			...
			this.foldImportsCheckbutton.Hide ();
			this.Show ();
		}
	}
}
